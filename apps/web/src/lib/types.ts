/**
 * Exact mirrors of the mailmux backend JSON.
 *
...
export type HealthResponse = { ok: true; service: "mailmux"; fixture: boolean };

/** GET /api/health — authenticated */
export type ApiHealthResponse = { ok: true; service: "mailmux"; version: string };
