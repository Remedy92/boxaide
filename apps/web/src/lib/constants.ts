 ...
 * a Boxaide rule and there is no way around it, so the wizard leads with it
...
export const PROVIDER_PRESETS: readonly ProviderPreset[] = [
  {
    ...
    steps: [
      ...
      "Type Boxaide as the name and press Create.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Press the plus button, type Boxaide as the label, and confirm with your Apple Account password.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Press New App Password, name it Boxaide, and allow it Mail (IMAP/SMTP) access.",
  ...
  },
  {
    ...
    steps: [
      ...
      "If your provider offers app passwords, make one for Boxaide rather than using your account password.",
